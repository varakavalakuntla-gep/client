            ...
            return(
                <div className="notificationComponent">
                    ...
                    <div className="notificationMenu">
                        <span className={(this.state.filter == 'all' ? 'active' : '')} onClick={()=> this.change('all')}>All</span>
                        <span className={(this.state.filter == 'unread' ? 'active' : '')} onClick={()=> this.change('unread')}>Unread</span>
                        <span className={(this.state.filter == 'anouncements' ? 'active' : '')} onClick={()=> this.change('anouncements')}>Anouncements</span>
                        <div>
